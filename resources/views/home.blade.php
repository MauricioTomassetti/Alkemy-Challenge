    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <a href="{{ route('posts.index')}}">
                ...
                <a class="nav-link active btn btn-lg btn-outline-primary mt-2" href="{{ route('posts.index')}}">Ver
                    Nuestros posts</a>
            </a>
        </div>
        <div class="col-md-6">
            ...
            <a class="nav-link active btn btn-lg btn-outline-success mt-2" href="{{ route('posts.create')}}">Agregar un
                nuevo Post</a>
        </div>
    </div>
</div>
